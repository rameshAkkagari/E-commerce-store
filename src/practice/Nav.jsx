    ...
    <>
     <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
      <div className="flex flex-col gap-2">
        <img
          alt="Clothing"
          className="aspect-[1.6] rounded-lg object-cover overflow-hidden"
          height={250}
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqKrA0er90LkB21SUccqN8xwMOiHYyqMGEwwSgMg6rcw&s"
          width={400}
        />
        <div className="flex flex-col gap-1">
          <h3 className="text-lg font-semibold">Clothing</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Shop stylish and comfortable clothing for all seasons.
          </p>
        </div>
      </div>
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Discover the latest gadgets and tech accessories.</p>
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <img
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Find unique decorations to style your home.</p>
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <img
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Explore products to support a healthy lifestyle.</p>
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <img
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Fun and entertaining options for kids of all ages.</p>
        </div>
      </div>
    </div>
