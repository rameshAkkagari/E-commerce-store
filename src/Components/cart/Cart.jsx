...
//       <DialogBody className='flex justify-center flex-col items-start'>
//         {cart.map((item,index)=>{
//             return (
//                 <div key={index}>
...
//                             seleted size : <span className='ml-2'>{item.size}</span>
//                         </p>

//                         <p className='text-black text-sm font-inter font-bold tracking-normal leading-none pt-2'>
//                             seleted color : <span style={{backgroundColor:item.color}} className='ml-2 rounded-full px-2'>
...
//                                 <Button size='sm' color='red' ripple={true} variant='filled'>Remove</Button>
//                             </Tooltip>
//                         </div>
//                     </div>
//                 </div>
  ...
  return (
    <div>
      {cart.length > 0 ? (
        <Fragment>
          <Dialog
            className="border-0 outline-0 overflow-x-visible"
            open={openModal}
            handler={() => setOpen(false)}
            animate={{
              mount: { scale: 1, y: 0 },
